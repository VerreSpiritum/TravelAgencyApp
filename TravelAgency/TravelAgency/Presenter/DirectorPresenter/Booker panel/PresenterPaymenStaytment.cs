...
{
    internal class PresenterPaymentStaytment
    {
        ModelPaymentStaytment model;
        IViewPaymentStaytment view;

        public PresenterPaymentStaytment(ModelPaymentStaytment model, IViewPaymentStaytment view)
        {
            this.model = model;
            this.view = view;
