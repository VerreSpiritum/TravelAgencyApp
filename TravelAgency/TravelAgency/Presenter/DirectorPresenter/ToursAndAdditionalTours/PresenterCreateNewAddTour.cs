...
{
    internal class PresenterCreateNewAddTour
    {
        IViewCreateNewAddTour view;
        ModelCreateNewAddTour model;

        public PresenterCreateNewAddTour(IViewCreateNewAddTour view, ModelCreateNewAddTour model)
        {
            this.view = view;
            this.model = model;
