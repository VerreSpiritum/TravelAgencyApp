...
{
    internal class PresenterEditTour
    {
        IViewEditTour view;
        ModelEditTour model;

        public PresenterEditTour(IViewEditTour view, ModelEditTour model)
        {
            this.view = view;
            this.model = model;

            view.SearchTour += View_SearchTour;
            view.EditThisTour += View_EditThisTour;
        }
